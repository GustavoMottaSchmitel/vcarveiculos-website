...
const CarCard: React.FC<CarCardProps> = ({ car, onViewDetails }) => {
    ...
    return (
        ...
        >
            ...
            {/* Badge de Tipo */}
            <div className="absolute top-4 right-4 z-10 px-3 py-1.5 rounded-full bg-gradient-to-r from-amber-600 to-amber-500 text-white text-xs font-bold shadow-lg">
                {car.tipo}
            </div>
                ...
                <div className="mt-auto pt-6 border-t border-gray-100">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="p-2.5 rounded-xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 shadow-sm">
            ...
            <div className="px-6 pb-6">
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 bg-gradient-to-r from-amber-600 to-amber-500 text-white font-bold rounded-xl hover:shadow-xl transition-all duration-300 group/btn relative overflow-hidden"
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-amber-700 to-amber-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
                </motion.button>
            </div>
        </motion.div>
    )
